        ...
        <Image
          css={`
            @supports (backdrop-filter: blur(5px)) {
                background-color: rgba(154,52,142,0.1);
            }
            background-color: rgba(154,52,142,0.6);
          `}
          sx={{
            // @supports ((WebkitBackdropFilter: 'blur(5px)') or (backdropFilter: 'blur(5px)')) {
            //     backgroundColor: 'rgba(255, 255, 255, 0.5)',
            //     backdropFilter: 'blur(10px) contrast(20%)',
            //     WebkitBackdropFilter: 'blur(10px) contrast(20%)',    
            // }, 
